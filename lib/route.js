...
var _validatePath = function validatePath(options) {
    ...
    if(!_.isString(options.path) && !_.isArray(options.path) && !(options.path instanceof RegExp)) {
        throw new TypeError('The "Route" object\'s property "path" is not a type of "String","Array", or "RegExp". Please verify that you are passing the correct value type into the "Route" for the path property');
    }
}
